...
public class Method1 {
    ...
    public void method1(double sa, double sb, double eps, int n, int save) {
        a.add(sa);
        b.add(sb);
    ...
    public void outputConsole() {
        ...
        for (int i = 0; i < a.size(); i++) {
            System.out.printf("|%-15d|%-15.4f|%-15.4f|%-15.4f|%-15.4f|%-15.4f|%-15.4f|%-15.4f|\n",
    ...
    public void outputFile(int n) {
        try {
            ...
            for (int i = 0; i < fa.size(); i++) {
                fileWriter.write(String.format("|%-15d|%-15.4f|%-15.4f|%-15.4f|%-15.4f|%-15.4f|%-15.4f|%-15.4f|\n",
                        i, a.get(i), b.get(i), x.get(i), fa.get(i), fb.get(i), fx.get(i), ab.get(i)));
                fileWriter.write("|---------------+---------------+---------------+" +
                        "---------------+---------------+---------------+---------------+---------------|\n");
            }
